...
if __name__ == '__main__':
    ...
    parser.add_argument('--max-to-generate', default=256, type=int)
    parser.add_argument('--temperature', default=0.2, type=float)
    parser.add_argument('--task-type', default=None, required=True, type=str)
    parser.add_argument('--test-dataset-type', default=None, required=True, type=str)  
    parser.add_argument('--train-dataset-type', default=None, required=True, type=str) 
